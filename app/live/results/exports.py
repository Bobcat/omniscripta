...
def build_live_result_metrics_snapshot(result_payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "asr_pool_ingest_body_read_total_s": result.get("asr_pool_ingest_body_read_s"),
        "asr_pool_ingest_multipart_parse_total_s": result.get("asr_pool_ingest_multipart_parse_s"),
        "asr_pool_ingest_audio_write_total_s": result.get("asr_pool_ingest_audio_write_s"),
        "asr_pool_ingest_submit_enqueue_total_s": result.get("asr_pool_ingest_submit_enqueue_s"),
