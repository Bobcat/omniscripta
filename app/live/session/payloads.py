...
def build_live_result_payload_from_parts(
    *,
    ...
    asr_pool_ingest_body_read_s: float,
    asr_pool_ingest_multipart_parse_s: float,
    asr_pool_ingest_audio_write_s: float,
    asr_pool_ingest_submit_enqueue_s: float,
    ...
    payload = {
        ...
        "asr_pool_ingest_body_read_s": round(float(max(0.0, asr_pool_ingest_body_read_s)), 3),
        "asr_pool_ingest_multipart_parse_s": round(float(max(0.0, asr_pool_ingest_multipart_parse_s)), 3),
        "asr_pool_ingest_audio_write_s": round(float(max(0.0, asr_pool_ingest_audio_write_s)), 3),
        "asr_pool_ingest_submit_enqueue_s": round(float(max(0.0, asr_pool_ingest_submit_enqueue_s)), 3),
...
def build_live_result_payload(sess: LiveSession) -> dict[str, Any]:
    return build_live_result_payload_from_parts(
        ...
        asr_pool_ingest_body_read_s=float(max(0.0, sess.asr_pool_ingest_body_read_s)),
        asr_pool_ingest_multipart_parse_s=float(max(0.0, sess.asr_pool_ingest_multipart_parse_s)),
        asr_pool_ingest_audio_write_s=float(max(0.0, sess.asr_pool_ingest_audio_write_s)),
        asr_pool_ingest_submit_enqueue_s=float(max(0.0, sess.asr_pool_ingest_submit_enqueue_s)),
...
def build_live_archive_result_payload(arc: ClosedSessionArchive) -> dict[str, Any]:
    ...
    return build_live_result_payload_from_parts(
        ...
        asr_pool_ingest_body_read_s=float(max(0.0, arc.asr_pool_ingest_body_read_s)),
        asr_pool_ingest_multipart_parse_s=float(max(0.0, arc.asr_pool_ingest_multipart_parse_s)),
        asr_pool_ingest_audio_write_s=float(max(0.0, arc.asr_pool_ingest_audio_write_s)),
        asr_pool_ingest_submit_enqueue_s=float(max(0.0, arc.asr_pool_ingest_submit_enqueue_s)),
